...
local BLACK_Msg = ''  
if msgs > 100 then 
BLACK_Msg = 'تفاعلك زفت' 
elseif msgs > 200 then 
BLACK_Msg = 'شويه شدها' 
elseif msgs > 300 then 
BLACK_Msg = 'شبه متفاعل ' 
elseif msgs > 600 then 
BLACK_Msg = 'عود متفاعل' 
elseif msgs > 1000 then 
BLACK_Msg = 'متفاعل كفو' 
elseif msgs > 1500 then 
BLACK_Msg = 'متفاعل جدا' 
elseif msgs > 2000 then 
BLACK_Msg = 'طاك مال تفاعل'  
elseif msgs > 4000 then 
BLACK_Msg = 'مخبل بلتفاعل' 
elseif msgs > 4500 then 
BLACK_Msg = 'مدمن تفاعل' 
elseif msgs > 5500 then 
BLACK_Msg = 'طاك' 
elseif msgs > 7000 then 
BLACK_Msg = 'يطك بالكاع' 
...
send(msg.sender_user_id_, msg.id_,' 𝑾𝒆𝒍𝒄𝒐𝒎𝒆  \n سيتم الرد عليك قريبا')
...
Text = '\n• البوت الان يتم تفعيله في القروبات من قبل المشرفين + المالكين '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
os.execute('wget https://raw.githubusercontent.com/PHFWHDHD/BLACK/main/BLACK.lua')
...
if text == '•القروبات•' and SudoBot(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n • القروبات> {`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
send(msg.chat_id_, msg.id_,'• عدد القروبات الان > { '..#group..' }'..BLACKk..''..BLACK..'\n*• الان عدد القروبات الحقيقي > { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,'• تغيير صورة القروب') 
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,' حفظ ترحيب القروب')   
return false   
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"•عذرا يا > {[@"..data.username_.."]}\n• الصوره التي ارسلتها تم منعها من القروب \n" ) 
else
send(msg.chat_id_,0,"•عذرا يا > {["..data.first_name_.."](T.ME/TEM_BLACK1)}\n• الصوره التي ارسلتها تم منعها من القروب \n") 
end
end,nil)   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"•عذرا يا > {[@"..data.username_.."]}\n• المتحركه التي ارسلتها تم منعها من القروب \n") 
else
send(msg.chat_id_,0,"•عذرا يا > {["..data.first_name_.."](T.ME/TEM_BLACK1)}\n• المتحركه التي ارسلتها تم منعها من القروب \n" ) 
end
end,nil)   
...
send(msg.chat_id_, msg.id_,'• القروب تم تفعليه من قبل')
else
sendText(msg.chat_id_,'\n•بواسطه ← ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n✔️¦ تم تفعيل القروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
send(msg.chat_id_, msg.id_,'• القروب تم تطيلها من قبل')
else
sendText(msg.chat_id_,'\n•بواسطه ← ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n✔️¦ تم تعطيل القروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'• تم تفعيل القروب بنجاح')
else
...
database:set(bot_id.."BLACK:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الزخرفه')
database:set(bot_id.."BLACK:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."BLACK:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."BLACK:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الابراج')
database:set(bot_id.."BLACK:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."BLACK:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."BLACK:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل حساب العمر')
database:set(bot_id.."BLACK:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."BLACK:age_Bots"..msg.chat_id_) == "open" then
local Textage = text:match("^احسب (.*)$")
ge = https.request('https://mode-dev.tk/Api1/BLACKapi.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
if name_Black then 
names_Black = database:smembers(bot_id.."BLACK:blocname"..msg.chat_id_) or ""
...
if tshake2.first_name_:match("(.*)"..database:get(bot_id.."BLACK:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."BLACK:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local tshake_nnn = database:get(bot_id.."BLACK:nump"..msg.chat_id_) or 5
local tshake_nnn2 = database:get(bot_id.."BLACK:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..BLACKChengName..']')
...
if text == 'م1' or text == 'م2' or text == 'م3' or text == 'م4' or text == 'م5' or text == 'اوامر البوت'  or text == 'اوامر' then
Text = [[
اهلا عزيزي
...
if text == '@eljo_ker_m' or text == '@TEM_BLACK1' or text == 'جوكر' then
Text = [[
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BLACK_SoUrcE')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'BLACK_SoUrcE')..') \n*•تم قفـل الدردشه*\n')  
end,nil)   
...
if text == 'قفل المنشن' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'del')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BLACK_SoUrcE')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'BLACK_SoUrcE')..') \n*تم قفـل المنشن*\n')  
end,nil)   
elseif text == 'قفل المنشن بالتقيد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'ked')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BLACK_SoUrcE')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'BLACK_SoUrcE')..') \n*تم قفـل المنشن بالتقيد*\n')  
end,nil)   
elseif text == 'قفل المنشن بالكتم' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'ktm')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BLACK_SoUrcE')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'BLACK_SoUrcE')..') \n*تم قفـل المنشن بالكتم*\n•*الحاله >الكتم*')  
end,nil)   
elseif text == 'قفل المنشن بالطرد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'kick')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BLACK_SoUrcE')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'BLACK_SoUrcE')..') \n*تم قفـل المنشن بالطرد\n•*الحاله >الطرد*')  
end,nil)   
elseif text == 'فتح المنشن' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BLACK_SoUrcE')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'BLACK_SoUrcE')..') \n*تم قفـل الالعاب*\n')  
end,nil)   
...
send(msg.chat_id_, msg.id_, "•لا يمكنك حظر المبرمج جوكر \n")
return false 
end
...
send(msg.chat_id_, msg.id_,'•  ??𝒆𝒍𝒄𝒐𝒎??  •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
function start_function(extra, result, success)
...
send(msg.chat_id_, msg.id_,'•  𝑾??𝒍𝒄𝒐𝒎𝒆  •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
...
if text == ("منشن للحمير") and Mod(msg) then
...
-----------------------------------------------------
if text == ("منشن للاغبياء") and Mod(msg) then
...
-----------------------------------------------------
if text == ("منشن للنصاب") and Mod(msg) then
local list = database:smembers(bot_id..'Naby:User'..msg.chat_id_)
t = "\n●○يا انبياء تعالو يبوكمم 😹😭💞 . \n●━━━━∴━━━━●\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t.."*︙"..k.."︙> [@"..username.."]●\n*"
...
---------
if text == ("رفع نصاب") or text == 'نصاب' or text == 'رفعه نصاب' and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-----------------------------------------------------
if text == ("منشن للكلاب") and Mod(msg) then
...
-----------------------------------------------------
if text == ("منشن للهطوف") and Mod(msg) then
...
---------
if text == ("رفع هطف") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل هطف")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-----------------------------------------------------
if text == ("منشن للخرفان") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n●○ياخرفان تعالو يبوكمم 😹😭💞 . \n●━━━━∴━━━━●\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t.."*︙"..k.."︙> [@"..username.."]●\n*"
...
-----------------------------------------------------
if text == ("منشن للقلوب") and Mod(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n●○مو قلتلك لاتجرحني تم تنزيلك من قلبي 😭💞'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
-----------------------------------------------------
if text == ("منشن للتوج") and Mod(msg) then
...
send(msg.chat_id_, msg.id_,'•  𝑾𝒆𝒍𝒄𝒐𝒎??  •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
...
send(msg.chat_id_,msg.id_,"• ارسل رابط القروب او رابط قناة القروب")
...
if not database:get(bot_id..'BLACK:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'BLACK:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ("منشن للكل") and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'•وجودنا جميع وبعدنا خساره تم مغادرة القروب') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'BLACK')..') '
...
send(msg.chat_id_, msg.id_,'• هذا الامر خاص بالمطور اكتب الاوامر وتحكم بالكيبورد') 
return false
end
if AddChannel(msg.sender_user_id_) == false then
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
database:del(bot_id..'BLACK:Tr'..msg.chat_id_)
KlamBLACK = {'سحور','سياره','استقبال','قنفه','ايفون','بزونه','مطبخ','كرستيانو','دجاجه','مدرسه','الوان','غرفه','ثلاجه','كهوه','سفينه','العراق','محطه','طياره','رادار','منزل','مستشفى','كهرباء','تفاحه','اخطبوط','سلمون','فرنسا','برتقاله','تفاح','مطرقه','بتيته','لهانه','شباك','باص','سمكه','ذباب','تلفاز','حاسوب','انترنيت','ساحه','جسر'};
name = KlamBLACK[math.random(#KlamBLACK)]
database:set(bot_id..'Klam:BLACK'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(database:get(bot_id..'Klam:BLACK'..msg.chat_id_) or '')..'' and not database:get(bot_id..'BLACK:Tr'..msg.chat_id_) then
if not database:get(bot_id..'BLACK:Tr'..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'•∞ الف مبروك لقد فزت \n•∞ للعب مره اخره ارسل ←{ الاسرع , ترتيب }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id..'BLACK:Tr'..msg.chat_id_,true)
end 
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [BLACK](https://t.me/TEM_BLACK1)
]]
...
if not database:get(bot_id..'BLACK:Reply:Mute'..msg.chat_id_) then
if text == "وش رأيك بهذا" or text == "وش رأيك بهذ" or text == "وش رأيك بذي" then
local texting = {"܁•شخص محبوب 🦄💞","܁•بحبه صراحه 🥺💞","܁•اطلق شخص 🥺💞","زغبا 😹💞.","܁•هذا موبشر ملاك 😹💞"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
return false
end
if text == "هينه" or text == "رزله" then
local texting = {"وانا فاضي اهين حيوانات 😹😭💘."," ماسوي شي ابعد 😭💘 ."}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
return false
end
if text == '🙂' then
...
database:del(bot_id..'BLACK:Reply:Mute'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'•تم تفعيل ردود البوت')
return false
end
if text == 'تعطيل ردود البوت' and Mod(msg) and database:get(bot_id.."AL:Sre:stats") then
database:set(bot_id..'BLACK:Reply:Mute'..msg.chat_id_,true)
