...
if Json_Info.result.can_chaBLACK e_info == true then
info = 'ꪜ'
else
info = '✘'
end
...
local id = tostriBLACK (msg.chat_id_)
...
if SudoBot(msg) then
local bl =  '-  𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝒏𝒊𝒈𝒈𝒂 المطور الاساسي \n سورس  بلاك \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/TEM_BLACK1) '
local keyboard = {
	{'•معلومات الكيبورد•'},
	  {'•ضع اسم للبوت•'},
...
send(msg.sender_user_id_, msg.id_,' 𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝒏𝒊𝒈𝒈𝒂 \n سيتم الرد عليك قريبا')
tdcli_function ({ID = "ForwardMessages", chat_id_ = SUDO,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..striBLACK .sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
...
if text == 'حظر' then
local Name = '['..striBLACK .sub(data.first_name_,0, 40)..'](tg://user?id='..id_user..')'
...
tdcli_function ({ ID = "SendChatAction",chat_id_ = id_user, action_ = {  ID = "SendMessageTypiBLACK Action", progress_ = 100} },function(arg,ta) 
...
chat_id_ = pv[i], action_ = {  ID = "SendMessageTypiBLACK Action", progress_ = 100} 
},function(arg,data) 
...
tdcli_function ({ID = "ChaBLACK eChatMemberStatus",chat_id_=group[i],user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
w = w + 1
end
...
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'TEM_BLACK1')..')'
...
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_BLACK1')..') '
status  = '\n تم ترقيته مطور في البوت'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• العضو> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TEM_BLACK1')..') \n •'..MODEDEV1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
return false  end 
database:del(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local username = striBLACK .match(text, "@[%a%d_]+") 
tdcli_function ({    
ID = "SearchPublicChat",    
username_ = username  
},function(arg,data) 
...
return false  end 
database:del(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local texxt = striBLACK .match(text, "(.*)") 
...
if database:get(bot_id..'ChaBLACK e:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) then 
if msg.content_.photo_.sizes_[3] then  
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_ 
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_ 
end 
tdcli_function ({ID = "ChaBLACK eChatPhoto",chat_id_ = msg.chat_id_,photo_ = getInputFile(photo_id) }, function(arg,data)   
if data.code_ == 3 then
send(msg.chat_id_, msg.id_,' عذرا البوت ليس ادمن يرجى ترقيتي والمحاوله لاحقا') 
database:del(bot_id..'ChaBLACK e:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
return false  end
...
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/TEM_BLACK1)}\n•["..MODEDEV_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
--------------------------------------------------------------------------------------------------------------
if not Special(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_,"flood") or 'nil'
NUM_MSG_MAX = database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_,"floodmax") or 5
TIME_CHECK = database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id..'floodc:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_,"flood") 
trigger_anti_spam(msg,type)  
end
database:setex(bot_id..'floodc:'..msg.sender_user_id_..':'..msg.chat_id_, tonumber(database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or 'nil'  
NUM_MSG_MAX = 5
if database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_,"floodmax") then
NUM_MSG_MAX = database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_,"floodtime") then
TIME_CHECK = database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
...
for k,v in pairs(list) do
print(striBLACK .find(text,v))
if striBLACK .find(text,v) ~= nil then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
end
...
local _nl, ctrl_ = striBLACK .gsub(text, '%c', '')  
local _nl, real_ = striBLACK .gsub(text, '%d', '')   
sens = 400  
if database:get(bot_id.."lock:Spam"..msg.chat_id_) == "del" and striBLACK .len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."lock:Spam"..msg.chat_id_) == "ked" and striBLACK .len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."lock:Spam"..msg.chat_id_) == "kick" and striBLACK .len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."lock:Spam"..msg.chat_id_) == "ktm" and striBLACK .len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
send(msg.chat_id_,0, "•عذرا يا > {["..data.first_name_.."](T.ME/TEM_BLACK1)}\n• الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendText(msg.chat_id_,'\n•بواسطه ← ['..striBLACK .sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n✔️¦ تم تفعيل المجموعه {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@TEM_BLACK1','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
local MODEDEVCheBLACK Name = database:get(bot_id.."MODEDEV:CheBLACK :Name"..data.id_)
if not data.first_name_ then 
if MODEDEVCheBLACK Name then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MODEDEVCheBLACK Name..']')
database:del(bot_id.."MODEDEV:CheBLACK :Name"..data.id_) 
end
end
if data.first_name_ then 
if MODEDEVCheBLACK Name ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
database:set(bot_id.."MODEDEV:CheBLACK :Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MODEDEVCheBLACK UserName = database:get(bot_id.."MODEDEV:CheBLACK :UserName"..data.id_)
if not data.username_ then 
if MODEDEVCheBLACK UserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MODEDEVCheBLACK UserName..']')
database:del(bot_id.."MODEDEV:CheBLACK :UserName"..data.id_) 
end
end
if data.username_ then 
if MODEDEVCheBLACK UserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."MODEDEV:CheBLACK :UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MODEDEVCheBLACK Photo = database:get(bot_id.."MODEDEV:CheBLACK :Photo"..data.id_)
if not data.profile_photo_ then 
if MODEDEVCheBLACK Photo then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
database:del(bot_id.."MODEDEV:CheBLACK :Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MODEDEVCheBLACK Photo ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."MODEDEV:CheBLACK :Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
╭• [𝑺𝑶𝑼𝑹𝑺𝑬 BLACK](t.me/TEM_BLACK1) •╮
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'سورس  بلاك' or text == 'اريد بوت تمبلر' or text == 'سورس  بلاك' then
Text = [[
•- DEV @eljo_ker_m مبرمج بوتات•
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
Text = [[
اهلا عزيزي
متوفر تنصيب بوتات ع سورس  بلاك
احدث واسرع البوتات وضمان الثقه
للاستفسار راسل المطور @eljo_ker_m
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == '@eljo_ker_m' or text == '@TEM_BLACK1' or text == 'الجوكر' then
Text = [[
@eljo_ker_m هذا مطور سورس  بلاك
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TEM_BLACK1')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'TEM_BLACK1')..') \n*•تم قفـل الدردشه*\n')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TEM_BLACK1')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'TEM_BLACK1')..') \n*تم قفـل الالعاب*\n')  
end,nil)   
...
send(msg.chat_id_, msg.id_,'•  ??𝒆𝒍𝒄𝒐𝒎?? 𝒏𝒊𝒈𝒈𝒂 •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
function start_function(extra, result, success)
...
local UserName = (b.username_ or "TEM_BLACK1")
...
tdcli_function ({ ID = "ChaBLACK eChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
...
tdcli_function ({ ID = "ChaBLACK eChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'• ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
...
tdcli_function ({ ID = "ChaBLACK eChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'• ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
...
tdcli_function ({ ID = "ChaBLACK eChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
end
...
tdcli_function ({ ID = "ChaBLACK eChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'TEM_BLACK1')..')'
status  = '\n تم الغاء حظره من هنا'
texts = usertext..status
else
...
tdcli_function ({ ID = "ChaBLACK eChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_BLACK1')..') ~'
status  = '\n تم الغاء حظره من هنا'
...
local TextEnd = {striBLACK .match(text, "^(كتم) (%d+) (.*)$")}
function start_function(extra, result, success)
...
local TextEnd = {striBLACK .match(text, "^(تقيد) (%d+) (.*)$")}
function start_function(extra, result, success)
if TextEnd[3] == 'يوم' then
Time_Restrict = TextEnd[2]:match('(%d+)')
Time = Time_Restrict * 86400
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_chaBLACK e_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_chaBLACK e_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
else
send(msg.chat_id_, msg.id_, '• لا يوجد حساب بهاذا المعرف')
end
end
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_chaBLACK e_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_chaBLACK e_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
else
send(msg.chat_id_, msg.id_, '• لا يوجد حساب بهاذا المعرف')
end
end
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_chaBLACK e_info=True&can_delete_messages=True&can_invite_users=True&can_restrict_members=True&can_pin_messages=True&can_promote_members=True")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_chaBLACK e_info=True&can_delete_messages=True&can_invite_users=True&can_restrict_members=True&can_pin_messages=True&can_promote_members=True")
else
send(msg.chat_id_, msg.id_, '• لا يوجد حساب بهاذا المعرف')
end
end
...
if database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_, "flood") == "kick" then     
flood = 'بالطرد •'     
elseif database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_,"flood") == "keed" then     
flood = 'بالتقيد •'     
elseif database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_,"flood") == "mute" then     
flood = 'بالكتم •'           
elseif database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_,"flood") == "del" then     
flood = 'بالمسح •'           
else     
flood = '✘'     
end
...
NUM_MSG_MAX = database:hget(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_,"floodmax") or 0
local text = 
...
send(msg.chat_id_, msg.id_,'•  𝑾𝒆𝒍𝒄𝒐𝒎?? 𝒏𝒊𝒈𝒈𝒂 •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
...
database:hset(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."floodiBLACK :settiBLACK s:"..msg.chat_id_ ,"floodtime" ,Num) 
...
database:set(bot_id..'ChaBLACK e:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_,true) 
...
database:setex(bot_id.."CHEBLACK :ID"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
> NIGGA
•يمكنك اضافة
• `#تعليق` تعليق الصوره
...
if database:get(bot_id.."CHEBLACK :ID"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"•تم الغاء تعين الايدي") 
database:del(bot_id.."CHEBLACK :ID"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
database:del(bot_id.."CHEBLACK :ID"..msg.chat_id_..""..msg.sender_user_id_) 
local CHEBLACK ER_ID = text:match("(.*)")  
database:set(bot_id.."KLISH:ID"..msg.chat_id_,CHEBLACK ER_ID)
...
local text1 = {striBLACK .match(text, "^(رفع) (.*) @(.*)$")}
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n• العضو > ['..result.title_..'](t.me/'..(text1[3] or 'TEM_BLACK1')..')'..'\n تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
local text1 = {striBLACK .match(text, "^(تنزيل) (.*) @(.*)$")}
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ ID = "ChaBLACK eChatTitle",chat_id_ = msg.chat_id_,title_ = Name },function(arg,data) 
if data.message_ == "Channel chat title can be chaBLACK ed by administrators only" then
send(msg.chat_id_,msg.id_,"• البوت ليس ادمن يرجى ترقيتي !")  
return false  
end 
if data.message_ == "CHAT_ADMIN_REQUIRED" then
...
if not database:sismember(bot_id..'Spam:TextiBLACK '..msg.sender_user_id_,text) then
...
database:sadd(bot_id..'Spam:TextiBLACK '..msg.sender_user_id_,text) 
end
if stekr then 
...
if text == ""..(database:get(bot_id..'Name:Bot') or ' بلاك').." غادر" or text == 'بوت غادر' then  
if Sudo(msg) and not database:get(bot_id..'Left:Bot'..msg.chat_id_)  then 
tdcli_function ({ID = "ChaBLACK eChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
...
tdcli_function({ID="ChaBLACK eChatMemberStatus",chat_id_=msg.chat_id_,user_id_=msg.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'• ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
...
tdcli_function ({ ID = "ChaBLACK eChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
...
Text = ' • عدد جهاتك > ['..Num..'](https://t.me/TEM_BLACK1) •'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id.."numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = striBLACK .match(text, "(%d+)") 
...
local txt = {striBLACK .match(text, "^(كول) (.*)$")}
...
name = striBLACK .gsub(name,'سحور','س ر و ح')
name = striBLACK .gsub(name,'سياره','ه ر س ي ا')
name = striBLACK .gsub(name,'استقبال','ل ب ا ت ق س ا')
name = striBLACK .gsub(name,'قنفه','ه ق ن ف')
name = striBLACK .gsub(name,'ايفون','و ن ف ا')
name = striBLACK .gsub(name,'بزونه','ز و ه ن')
name = striBLACK .gsub(name,'مطبخ','خ ب ط م')
name = striBLACK .gsub(name,'كرستيانو','س ت ا ن و ك ر ي')
name = striBLACK .gsub(name,'دجاجه','ج ج ا د ه')
name = striBLACK .gsub(name,'مدرسه','ه م د ر س')
name = striBLACK .gsub(name,'الوان','ن ا و ا ل')
name = striBLACK .gsub(name,'غرفه','غ ه ر ف')
name = striBLACK .gsub(name,'ثلاجه','ج ه ت ل ا')
name = striBLACK .gsub(name,'كهوه','ه ك ه و')
name = striBLACK .gsub(name,'سفينه','ه ن ف ي س')
name = striBLACK .gsub(name,'العراق','ق ع ا ل ر ا')
name = striBLACK .gsub(name,'محطه','ه ط م ح')
name = striBLACK .gsub(name,'طياره','ر ا ط ي ه')
name = striBLACK .gsub(name,'رادار','ر ا ر ا د')
name = striBLACK .gsub(name,'منزل','ن ز م ل')
name = striBLACK .gsub(name,'مستشفى','ى ش س ف ت م')
name = striBLACK .gsub(name,'كهرباء','ر ب ك ه ا ء')
name = striBLACK .gsub(name,'تفاحه','ح ه ا ت ف')
name = striBLACK .gsub(name,'اخطبوط','ط ب و ا خ ط')
name = striBLACK .gsub(name,'سلمون','ن م و ل س')
name = striBLACK .gsub(name,'فرنسا','ن ف ر س ا')
name = striBLACK .gsub(name,'برتقاله','ر ت ق ب ا ه ل')
name = striBLACK .gsub(name,'تفاح','ح ف ا ت')
name = striBLACK .gsub(name,'مطرقه','ه ط م ر ق')
name = striBLACK .gsub(name,'بتيته','ب ت ت ي ه')
name = striBLACK .gsub(name,'لهانه','ه ن ل ه ل')
name = striBLACK .gsub(name,'شباك','ب ش ا ك')
name = striBLACK .gsub(name,'باص','ص ا ب')
name = striBLACK .gsub(name,'سمكه','ك س م ه')
name = striBLACK .gsub(name,'ذباب','ب ا ب ذ')
name = striBLACK .gsub(name,'تلفاز','ت ف ل ز ا')
name = striBLACK .gsub(name,'حاسوب','س ا ح و ب')
name = striBLACK .gsub(name,'انترنيت','ا ت ن ر ن ي ت')
name = striBLACK .gsub(name,'ساحه','ح ا ه س')
name = striBLACK .gsub(name,'جسر','ر ج س')
...
name = striBLACK .gsub(name,'الجرس','شيئ اذا لمسته صرخ ما هوه ؟')
name = striBLACK .gsub(name,'عقرب الساعه','اخوان لا يستطيعان تمضيه اكثر من دقيقه معا فما هما ؟')
name = striBLACK .gsub(name,'السمك','ما هو الحيوان الذي لم يصعد الى سفينة نوح عليه السلام ؟')
name = striBLACK .gsub(name,'المطر','شيئ يسقط على رأسك من الاعلى ولا يجرحك فما هو ؟')
name = striBLACK .gsub(name,'5','ما العدد الذي اذا ضربته بنفسه واضفت عليه 5 يصبح ثلاثين ')
name = striBLACK .gsub(name,'الكتاب','ما الشيئ الذي له اوراق وليس له جذور ؟')
name = striBLACK .gsub(name,'البسمار','ما هو الشيئ الذي لا يمشي الا بالضرب ؟')
name = striBLACK .gsub(name,'7','عائله مؤلفه من 6 بنات واخ لكل منهن .فكم عدد افراد العائله ')
name = striBLACK .gsub(name,'الكعبه','ما هو الشيئ الموجود وسط مكة ؟')
name = striBLACK .gsub(name,'بيت الشعر','ما هو البيت الذي ليس فيه ابواب ولا نوافذ ؟ ')
name = striBLACK .gsub(name,'لهانه','وحده حلوه ومغروره تلبس مية تنوره .من هيه ؟ ')
name = striBLACK .gsub(name,'انا','ابن امك وابن ابيك وليس باختك ولا باخيك فمن يكون ؟')
name = striBLACK .gsub(name,'امي','اخت خالك وليست خالتك من تكون ؟ ')
name = striBLACK .gsub(name,'الابره','ما هو الشيئ الذي كلما خطا خطوه فقد شيئا من ذيله ؟ ')
name = striBLACK .gsub(name,'الساعه','ما هو الشيئ الذي يقول الصدق ولكنه اذا جاع كذب ؟')
name = striBLACK .gsub(name,'22','كم مره ينطبق عقربا الساعه على بعضهما في اليوم الواحد ')
name = striBLACK .gsub(name,'خطأ','ما هي الكلمه الوحيده التي تلفض خطأ دائما ؟ ')
name = striBLACK .gsub(name,'كم الساعه','ما هو السؤال الذي تختلف اجابته دائما ؟')
name = striBLACK .gsub(name,'البيتنجان','جسم اسود وقلب ابيض وراس اخظر فما هو ؟')
name = striBLACK .gsub(name,'البيض','ماهو الشيئ الذي اسمه على لونه ؟')
name = striBLACK .gsub(name,'المرايه','ارى كل شيئ من دون عيون من اكون ؟ ')
name = striBLACK .gsub(name,'الضوء','ما هو الشيئ الذي يخترق الزجاج ولا يكسره ؟')
name = striBLACK .gsub(name,'الهواء','ما هو الشيئ الذي يسير امامك ولا تراه ؟')
name = striBLACK .gsub(name,'الضل','ما هو الشيئ الذي يلاحقك اينما تذهب ؟ ')
name = striBLACK .gsub(name,'العمر','ما هو الشيء الذي كلما طال قصر ؟ ')
name = striBLACK .gsub(name,'القلم','ما هو الشيئ الذي يكتب ولا يقرأ ؟')
name = striBLACK .gsub(name,'المشط','له أسنان ولا يعض ما هو ؟ ')
name = striBLACK .gsub(name,'الحفره','ما هو الشيئ اذا أخذنا منه ازداد وكبر ؟')
name = striBLACK .gsub(name,'البحر','ما هو الشيئ الذي يرفع اثقال ولا يقدر يرفع مسمار ؟')
name = striBLACK .gsub(name,'الثلج','انا ابن الماء فان تركوني في الماء مت فمن انا ؟')
name = striBLACK .gsub(name,'الاسفنج','كلي ثقوب ومع ذالك احفض الماء فمن اكون ؟')
name = striBLACK .gsub(name,'الصوت','اسير بلا رجلين ولا ادخل الا بالاذنين فمن انا ؟')
name = striBLACK .gsub(name,'بلم','حامل ومحمول نصف ناشف ونصف مبلول فمن اكون ؟ ')
...
name = striBLACK .gsub(name,'قرد','🐒')
name = striBLACK .gsub(name,'دجاجه','🐔')
name = striBLACK .gsub(name,'بطريق','🐧')
name = striBLACK .gsub(name,'ضفدع','🐸')
name = striBLACK .gsub(name,'بومه','🦉')
name = striBLACK .gsub(name,'نحله','🐝')
name = striBLACK .gsub(name,'ديك','🐓')
name = striBLACK .gsub(name,'جمل','🐫')
name = striBLACK .gsub(name,'بقره','🐄')
name = striBLACK .gsub(name,'دولفين','🐬')
name = striBLACK .gsub(name,'تمساح','🐊')
name = striBLACK .gsub(name,'قرش','🦈')
name = striBLACK .gsub(name,'نمر','🐅')
name = striBLACK .gsub(name,'اخطبوط','🐙')
name = striBLACK .gsub(name,'سمكه','🐟')
name = striBLACK .gsub(name,'خفاش','🦇')
name = striBLACK .gsub(name,'اسد','🦁')
name = striBLACK .gsub(name,'فأر','🐭')
name = striBLACK .gsub(name,'ذئب','🐺')
name = striBLACK .gsub(name,'فراشه','🦋')
name = striBLACK .gsub(name,'عقرب','🦂')
name = striBLACK .gsub(name,'زرافه','🦒')
name = striBLACK .gsub(name,'قنفذ','🦔')
name = striBLACK .gsub(name,'تفاحه','🍎')
name = striBLACK .gsub(name,'باذنجان','🍆')
...
name = striBLACK .gsub(name,'باي','هلو')
name = striBLACK .gsub(name,'فهمت','مافهمت')
name = striBLACK .gsub(name,'موزين','زين')
name = striBLACK .gsub(name,'اسمعك','ماسمعك')
name = striBLACK .gsub(name,'احبك','ماحبك')
name = striBLACK .gsub(name,'موحلو','حلو')
name = striBLACK .gsub(name,'نضيف','وصخ')
name = striBLACK .gsub(name,'حاره','بارده')
name = striBLACK .gsub(name,'ناصي','عالي')
name = striBLACK .gsub(name,'جوه','فوك')
name = striBLACK .gsub(name,'سريع','بطيء')
name = striBLACK .gsub(name,'ونسه','ضوجه')
name = striBLACK .gsub(name,'طويل','قزم')
name = striBLACK .gsub(name,'سمين','ضعيف')
name = striBLACK .gsub(name,'ضعيف','قوي')
name = striBLACK .gsub(name,'شريف','كواد')
name = striBLACK .gsub(name,'شجاع','جبان')
name = striBLACK .gsub(name,'رحت','اجيت')
name = striBLACK .gsub(name,'عدل','ميت')
name = striBLACK .gsub(name,'نشيط','كسول')
name = striBLACK .gsub(name,'شبعان','جوعان')
name = striBLACK .gsub(name,'موعطشان','عطشان')
name = striBLACK .gsub(name,'خوش ولد','موخوش ولد')
name = striBLACK .gsub(name,'اني','مطي')
name = striBLACK .gsub(name,'هادئ','عصبي')
...
name = striBLACK .gsub(name,'😸','😹😹😹😹😹😹😹•😸😹😹•😹')
name = striBLACK .gsub(name,'☠','💀💀💀💀💀💀💀☠💀💀💀💀💀')
name = striBLACK .gsub(name,'🐼','👻??👻🐼👻👻👻👻👻👻👻')
name = striBLACK .gsub(name,'🐇','🕊🕊🕊🕊🕊🐇🕊🕊🕊🕊')
name = striBLACK .gsub(name,'🌑','🌚🌚🌚🌚🌚🌑🌚🌚🌚')
name = striBLACK .gsub(name,'🌚','🌑🌑🌑🌑🌑🌚🌑🌑🌑')
name = striBLACK .gsub(name,'⭐️','🌟🌟🌟🌟🌟🌟🌟🌟⭐️🌟🌟🌟')
name = striBLACK .gsub(name,'•','💫💫💫💫💫•💫💫💫💫')
name = striBLACK .gsub(name,'⛈','🌨🌨🌨🌨🌨⛈🌨🌨🌨🌨')
name = striBLACK .gsub(name,'🌥','⛅️⛅️⛅️⛅️⛅️⛅️🌥⛅️⛅️⛅️⛅️')
name = striBLACK .gsub(name,'⛄️','☃☃☃☃☃☃⛄️☃☃☃☃')
name = striBLACK .gsub(name,'👨‍🔬','👩‍🔬👩‍🔬👩‍🔬👩‍🔬👩‍🔬??‍🔬👩‍🔬👩‍🔬👨‍🔬👩‍🔬👩‍🔬👩‍🔬')
name = striBLACK .gsub(name,'•','👩‍💻👩‍💻👩‍‍💻👩‍‍💻👩‍💻•👩‍💻👩‍💻??‍💻')
name = striBLACK .gsub(name,'👨‍🔧','👩‍🔧👩‍🔧👩‍🔧👩‍🔧👩‍🔧👩‍🔧👨‍🔧👩‍🔧')
...
name = striBLACK .gsub(name,'🧝‍♂','🧝‍♀🧝‍♀🧝‍♀🧝‍♀🧝‍♀🧝‍♂🧝‍♀🧝‍♀🧝‍♀')
name = striBLACK .gsub(name,'🙍‍♂️','🙎‍♂️🙎‍♂️🙎‍♂️🙎‍♂️•‍♂️🙍‍♂️🙎‍♂️🙎‍♂️🙎‍♂️')
name = striBLACK .gsub(name,'🧖‍♂️','🧖‍♀️🧖‍♀️🧖‍♀️🧖‍♀️🧖‍♀️🧖‍♂️🧖‍♀️🧖‍♀️🧖‍♀️🧖‍♀️')
name = striBLACK .gsub(name,'👬','👭👭👭👭👭👬👭👭👭')
name = striBLACK .gsub(name,'👨‍👨‍👧','👨‍👨‍👦👨‍👨‍👦👨‍👨‍??👨‍👨‍👦👨‍👨‍👧👨‍👨‍👦👨‍👨‍👦')
name = striBLACK .gsub(name,'🕒','🕒🕒🕒🕒🕒🕒🕓🕒🕒🕒')
name = striBLACK .gsub(name,'🕤','🕥🕥🕥🕥🕥🕤🕥🕥🕥')
...
name = striBLACK .gsub(name,'9','2+7=')
name = striBLACK .gsub(name,'2','5-3=')
name = striBLACK .gsub(name,'60','(30)² =')
name = striBLACK .gsub(name,'9','2+2+5=')
name = striBLACK .gsub(name,'5','8-3=?')
name = striBLACK .gsub(name,'4','40÷10=')
name = striBLACK .gsub(name,'25','30-5=')
name = striBLACK .gsub(name,'10','100÷10=')
name = striBLACK .gsub(name,'17','10+5+2=')
name = striBLACK .gsub(name,'15','25-10=')
name = striBLACK .gsub(name,'39','44-5=')
name = striBLACK .gsub(name,'5','12+1-8=')
name = striBLACK .gsub(name,'16','16+16-16=')
...
name = Hussein[math.random(#Hussein)]
database:del(bot_id..'Set:EBLACK lish:Bot'..msg.chat_id_)
database:set(bot_id..':Set:EBLACK lish'..msg.chat_id_,name)
name = striBLACK .gsub(name,'ذئب','Wolf')
name = striBLACK .gsub(name,'معلومات','Information')
name = striBLACK .gsub(name,'قنوات','Channels')
name = striBLACK .gsub(name,'مجموعات','Groups')
name = striBLACK .gsub(name,'كتاب','Book')
name = striBLACK .gsub(name,'تفاحه','Apple')
name = striBLACK .gsub(name,'سدني','Sydney')
name = striBLACK .gsub(name,'نقود','money')
name = striBLACK .gsub(name,'اعلم','I know')
name = striBLACK .gsub(name,'تمساح','crocodile')
name = striBLACK .gsub(name,'مختلف','Different')
name = striBLACK .gsub(name,'ذكي','Intelligent')
send(msg.chat_id_, msg.id_,'اجب عن التالي ~ { '..name..' }')
return false
end
end
------------------------------------------------------------------------
if text == ''..(database:get(bot_id..':Set:EBLACK lish'..msg.chat_id_) or '')..'' then 
if not database:get(bot_id..'Set:EBLACK lish:Bot'..msg.chat_id_) then 
database:del(bot_id..':Set:EBLACK lish'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'•┇ الف مبروك لقد فزت \n•┇ للعب مره اخره ارسل ←{ `انكليزي` }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id..'Set:EBLACK lish:Bot'..msg.chat_id_,true)
end
------------------------------------------------------------------------
if text == 'امثله' then
if AddChannel(msg.sender_user_id_) == false then
...
name = striBLACK .gsub(name,'جوز','ينطي____للماعده سنون')
name = striBLACK .gsub(name,'ضراطه','الي يسوق المطي يتحمل___')
name = striBLACK .gsub(name,'بيدك','اكل___محد يفيدك')
name = striBLACK .gsub(name,'الحافي','تجدي من___نعال')
name = striBLACK .gsub(name,'شقره','مع الخيل يا___')
name = striBLACK .gsub(name,'النخله','الطول طول___والعقل عقل الصخلة')
name = striBLACK .gsub(name,'سلايه','بالوجه امراية وبالظهر___')
name = striBLACK .gsub(name,'الخيل','من قلة___شدو على الچلاب سروج')
name = striBLACK .gsub(name,'حداد','موكل من صخم وجهه كال اني___')
name = striBLACK .gsub(name,'المبلل','___ما يخاف من المطر')
name = striBLACK .gsub(name,'الحبل','اللي تلدغة الحية يخاف من جرة___')
name = striBLACK .gsub(name,'يركص','المايعرف___يكول الكاع عوجه')
name = striBLACK .gsub(name,'العنب','المايلوح___يكول حامض')
name = striBLACK .gsub(name,'العمه','___إذا حبت الچنة ابليس يدخل الجنة')
name = striBLACK .gsub(name,'الخبز','انطي___للخباز حتى لو ياكل نصه')
name = striBLACK .gsub(name,'باحصاد','اسمة___ومنجله مكسور')
name = striBLACK .gsub(name,'شهر','امشي__ولا تعبر نهر')
name = striBLACK .gsub(name,'شكه','يامن تعب يامن__يا من على الحاضر لكة')
name = striBLACK .gsub(name,'القرد','__بعين امه غزال')
name = striBLACK .gsub(name,'يكحله','اجه___عماها')
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [TEM BLACK  - SoUrCe](https://t.me/TEM_BLACK1)
]]
...
local textiBLACK  = {"܁•كلش حباب وهاي 🦄💞","܁•الكياته تبعه تقرا 1000 🥺💞","܁•اطلق شخص شحبه 🥺💞","زغبا 😹💞.","܁•يوتيوبر رب المعيدي 😹💞"}
send(msg.chat_id_, msg.id_, ''..textiBLACK [math.random(#textiBLACK )]..'')
return false
end
if text == "هينه" or text == "رزله" then
local textiBLACK  = {"مااهين حيوانات اني 😹😭💘."," ماا وخر ماسوي شي 😭💘 ."}
send(msg.chat_id_, msg.id_, ''..textiBLACK [math.random(#textiBLACK )]..'')
return false
end
if text == "مصه" or text == "بوسه" then
local textiBLACK  = {"ما ما ما اخجل شني 😭??💞","ماا وخر مابوسك 😭💞💞"," ما ما ما اخجل شني 😭😭💞"}
send(msg.chat_id_, msg.id_, ''..textiBLACK [math.random(#textiBLACK )]..'')
return false
end
if text == 'هلو' then
...
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
if text and not database:sismember(bot_id..'Spam:TextiBLACK '..msg.sender_user_id_,text) then
database:del(bot_id..'Spam:TextiBLACK '..msg.sender_user_id_) 
end
--------------------------------------------------------------------------------------------------------------
...
nightraBLACK  = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(nightraBLACK )
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = getChatId(msg.chat_id_).ID,filter_ = {ID = "ChannelMembersBots"},offset_ = 0,limit_ = 100 },function(arg,tah) local admins = tah.members_ for i=0 , #admins do if tah.members_[i].status_.ID ~= "ChatMemberStatusEditor" and not is_mod(msg) then tdcli_function ({ID = "ChaBLACK eChatMemberStatus",chat_id_ = msg.chat_id_,user_id_ = admins[i].user_id_,status_ = {ID = "ChatMemberStatusKicked"},}, function(arg,f) end, nil) end end end,nil)  
end
end     
end
end
...
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatDeletePhoto" or msg.content_.ID == "MessageChatChaBLACK ePhoto" or msg.content_.ID == 'MessagePinMessage' or msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" or msg.content_.ID == 'MessageChatChaBLACK eTitle' or msg.content_.ID == "MessageChatDeleteMember" then   
if database:get(bot_id..'lock:tagservr'..msg.chat_id_) then  
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false
end    
...
send(msg.chat_id_,0,"•العضو : {["..data.first_name_.."](T.ME/TEM_BLACK1)}\n•["..MODEDEVAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
...
tdcli_function ({ID = "ChaBLACK eChatMemberStatus",chat_id_=v,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'Chek:Groups',v)  
end
